...
const Map DAMAGE = {{"KICK", 10},{"PUNCH", 5}, {"KICKDOWN", 20} ,{"PUNCHUP", 20},{"SHOOT", 20}, {"DEFENSE", 0}, {"PUNCHJUMPLEFT", 20}, {"PUNCHJUMPRIGHT", 20}};
//
...
//
enum Events { MoveRight, MoveLeft, Jump, Duck, HighPunch, LowPunch, HighKick, LowKick, Block, Shoot, ReceiveHit, MoveRightRelease, MoveLeftRelease, DuckRelease, BlockRelease, ShootingReceived, animationFinished};
#endif /* CONSTANTES_H_ */
